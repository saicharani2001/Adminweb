...
@Component({
  selector: 'app-managerrgstr',
  templateUrl: './managerrgstr.component.html',
  styleUrls: ['./managerrgstr.component.css']
})
export class ManagerrgstrComponent implements OnInit {
  registerForm={
    fullname:"",
    age:null,
    licenseId:"",
